...
namespace Priority_Queue
{
	...
	public abstract class FastPriorityQueue<T, TPriority> : IFixedSizePriorityQueue<T, TPriority> where T : FastPriorityQueueNode<TPriority>
	{
	...
	public class FastPriorityQueue<T> : FastPriorityQueue<T, float> where T : FastPriorityQueueNode<float>
	{
		public FastPriorityQueue( int maxNodes )
			: base( maxNodes )
		{
